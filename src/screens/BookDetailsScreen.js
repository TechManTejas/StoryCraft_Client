        ...
        <>
          ...
          <View style={styles.detailsContainer}>
            <View style={styles.authorContainer}>
              <FontAwesome name="user-circle-o" size={24} color="#23298E" style={styles.profileIcon} />
          ...
          <View style={styles.chapterScrollView}>
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.chapterContainer}>
